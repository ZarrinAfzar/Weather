...
Color.prototype = {
	...
	red: function (val) {
		return this.setSensor('rgb', 0, val);
	},
	green: function (val) {
		return this.setSensor('rgb', 1, val);
	},
	blue: function (val) {
		return this.setSensor('rgb', 2, val);
	},
	hue: function (val) {
		if (val) {
			val %= 360;
		...
		return this.setSensor('hsl', 0, val);
	},
	saturation: function (val) {
		return this.setSensor('hsl', 1, val);
	},
	lightness: function (val) {
		return this.setSensor('hsl', 2, val);
	},
	saturationv: function (val) {
		return this.setSensor('hsv', 1, val);
	},
	whiteness: function (val) {
		return this.setSensor('hwb', 1, val);
	},
	blackness: function (val) {
		return this.setSensor('hwb', 2, val);
	},
	value: function (val) {
		return this.setSensor('hsv', 2, val);
	},
	cyan: function (val) {
		return this.setSensor('cmyk', 0, val);
	},
	magenta: function (val) {
		return this.setSensor('cmyk', 1, val);
	},
	yellow: function (val) {
		return this.setSensor('cmyk', 2, val);
	},
	black: function (val) {
		return this.setSensor('cmyk', 3, val);
	},
...
Color.prototype.setSensor = function (space, index, val) {
