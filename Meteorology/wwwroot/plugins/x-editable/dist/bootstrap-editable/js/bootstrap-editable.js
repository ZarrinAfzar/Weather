...
/**
Typeahead input (bootstrap 2 only). Based on Twitter Bootstrap 2 [typeahead](https://getbootstrap.com/2.3.2/javascript.html#typeahead).  
...
//                i = $(that.options.item).attr('data-value', item)
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.list.defaults, {
        ...
        **/         
        tpl:'<input type="text">',
        /**
        Configuration of typeahead. [Full list of options](https://getbootstrap.com/2.3.2/javascript.html#typeahead).
