    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        splitOptions: function() {
            ...
            if(!$.ui[this.containerName]) {
                $.error('Please use jQueryUI with "tooltip" widget! https://jqueryui.com/download');
                return;
            }
...
Description and examples: https://jqueryui.com/datepicker.   
...
(function ($) {
    ...
    DateUI.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/         
        ...
        /**
        Format used for sending value to server. Also applied when converting date from <code>data-value</code> attribute.<br>
        Full list of tokens: https://docs.jquery.com/UI/Datepicker/formatDate
        ...
        **/          
        ...
        Full list of options: https://api.jqueryui.com/datepicker
