...
{
    [Authorize(Roles = "AdminiStratore,RainReport")]
    public class RainReportController : Controller
    {

        private readonly GenericUoW _genericUoW;
        private readonly UserManager<User> _userManager;
        public RainReportController(GenericUoW genericUoW, UserManager<User> userManager)
        {
        ...
        public IActionResult RainReport_List(int stationId,string startDate, string endDate)
        {
            try
            {
                ...
                Parametr[2, 1] = stationId.ToString();
                               var model = _genericUoW.GetFromSp(Parametr, "Sp_RainData2");
        ...
        public IActionResult ExportToExcel(int stationId,string stationname, string startDate, string endDate)
        {
            ...
            Parametr[2, 0] = "@StationId";
            Parametr[2, 1] = stationId.ToString();
            DataTable dt = _genericUoW.GetFromSp(Parametr, "Sp_RainDataExport2");
