...
{
    [Authorize(Roles = "AdminiStratore,SendSMS")]
    public class SendSMSController : Controller
    {

        private readonly GenericUoW _genericUoW;
        private readonly UserManager<User> _userManager;
        public SendSMSController(GenericUoW genericUoW, UserManager<User> userManager)
        {
        ...
        public IActionResult SendSMS_List( string startDate, string endDate)
        {
            try
            {
                ...
                DataTable model = _genericUoW.GetFromSp(Parametr, "Sp_SendSMS");
        ...
        {
            string export = "SendSMS_"+ DateTime.Now.ToPeString();
            DateTime stDate = startDate.ToGreDateTime();
            DateTime enDate = endDate.ToGreDateTime();
            ...
            DataTable dt = _genericUoW.GetFromSp(Parametr, "Sp_SendSMS");
